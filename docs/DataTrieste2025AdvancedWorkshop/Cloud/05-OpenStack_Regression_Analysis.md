...
## Import the Notebook
   ...
   * The Google Colab regression analysis is available at: [Colab_Regression](https://github.com/CODATA-RDA-DataScienceSchools/Materials/blob/master/docs/DataTrieste2024/CI/Colab_Regression_Spark.ipynb)
