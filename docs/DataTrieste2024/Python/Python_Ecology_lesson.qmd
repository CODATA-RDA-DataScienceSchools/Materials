...
We'll be using 4 datasets:
- [tmdb-movies.csv](https://raw.githubusercontent.com/deepak525/Investigate_TMDb_Movies/master/tmdb-movies.csv)
- [movies.csv](https://raw.githubusercontent.com/CODATA-RDA-DataScienceSchools/Materials/master/docs/DataTrieste2023/RecommenderSystems/movies.csv)
- [ratings.csv](https://raw.githubusercontent.com/CODATA-RDA-DataScienceSchools/Materials/master/docs/DataTrieste2023/RecommenderSystems/ratings.csv)
...
## Some other useful functions (3/3) {.hcenter}
