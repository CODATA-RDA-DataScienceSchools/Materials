...
![](images/joins.jpg){fig-align="center"}
...
- Matplotlib is the most basic and widely-used Python library for creating static, animated, and interactive visualisations. It provides a lot of control over every aspect of a plot.
...
- Plotnine is a Python implementation of the Grammar of Graphics (similar to R's ggplot2). It provides a high-level abstraction for creating complex plots by layering components.

## Comparison of Matplotlib, Seaborn, and Plotnine {.hcenter}

![](images/plotting-libraries.png){fig-align="center"}
