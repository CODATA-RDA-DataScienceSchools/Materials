...
![](images/presentation.png){fig-align="center"}
...
![](images/Absolute_vs_relative.PNG){fig-align="center" width="900"}
...
![](images/File_structure.PNG){fig-align="center"}
...
![](images/dataframe.svg){fig-align="center"}
...
![](images/Handbag2.png){fig-align="center"}
...
## Data manipulation using `dplyr` and `tidyr` {.hcenter}
...
![](images/split-apply-combine.png){fig-align="center"}

[It collapses each group into a single-row summary of that group]{.small}
...
![](images/Surveys_complete.PNG){fig-align="center"}
...
![](images/grammar_of_graphics.PNG){fig-align="center"}

## Data visualisation: grammar of graphics {.hcenter}

![](images/grammar_of_graphics3.png){fig-align="center" width="700"}
...
![](images/joins.png){fig-align="center" width="600"}
...
![](images/Final_summary.PNG){fig-align="center" width="700"}
